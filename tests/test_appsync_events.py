...
def test_asgi_get_v2_apis_appsync_api_localhost_discovers_api():
    """Unsigned GET /v2/apis with Host ``appsync-api.localhost`` (browser-style discovery).
    ...
    ae.reset()
    host = "appsync-api.localhost:4566"
...
def test_publish_with_appsync_sigv4_scope_on_events_vhost():
    ...
    ae.reset()
    mgmt_host = "appsync-api.localhost:4566"
    auth = _minimal_sigv4_appsync_authorization()
